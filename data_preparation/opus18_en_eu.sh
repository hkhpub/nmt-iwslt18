...
OUTPUT_DIR=/hdd/data/iwslt18/open-subtitles18
MAX_SEN_LEN=50

cd ${OUTPUT_DIR}

mkdir -p ${OUTPUT_DIR}/corpus.org
cp ${OUTPUT_DIR}/data.raw/train.* ${OUTPUT_DIR}/
cp ${OUTPUT_DIR}/data.raw/dev.* ${OUTPUT_DIR}/
cp ${OUTPUT_DIR}/data.raw/test.* ${OUTPUT_DIR}/
